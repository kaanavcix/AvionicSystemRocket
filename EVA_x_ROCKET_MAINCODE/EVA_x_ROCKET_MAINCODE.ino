...
float oankiDenizSeviyeBasinci=0; // set default data as 0
///////////////////////////////////////////////////////////////////////////////////
...
bmp280Sensor.setSampling(Adafruit_BMP280::MODE_NORMAL,     /* Operating Mode. */
  ...
  //bmp sensörü ile basınc almak ve o yerdeki seviyeye göre işlemlerde bulunmak;
oankiDenizSeviyeBasinci=bmp280Sensor.readPressure();  
...
void loop() { 
  ...
  filtreliGyro = mpu.readNormalizeGyro();
   ...
   Serial.println(bmp280Sensor.readAltitude(oankiDenizSeviyeBasinci));
...
////////////////////////////////////////////////////////////////////////////////
      ...
      *(float*)( rocketData.lang)= gps.location.lng(),6;
       Serial.print("Lng : "); Serial.println(*(float*)rocketData.lang);

    
      *(float*) (rocketData.late)= gps.location.lat(),6;
          Serial.print("Lat : "); Serial.println( *(float*) rocketData.late);

       
      *(float*)(rocketData.irtifa)= gps.altitude.meters(),6;
       Serial.print("Altitude : "); Serial.println(*(float*)rocketData.irtifa);}
       
else{
  
  
  
  Serial.println("Büyük Geçmiş Olsun Arkadaşlar :)");}
/////////////////////////////////////////////////////////////////////////////////////////
//Lora VERICI KODLARI//////////////
...
ResponseStatus rs = loraModul.sendFixedMessage(0, 5, 7 ,&rocketData, sizeof(Rockets));
